...
suspect(Name:Car:Gun) :- conduce(Name, Car), inarmat(Name, Gun).
...
au_pusca(Res) :- findall(X, inarmat(X, pusca), Res).
...
au_arma(Gun, Res) :- setof(X, inarmat(X, Gun), Res).

%au_marca(_Marca, _ListaNume) :- fail.

au_marca(Car, Res) :- setof(X, conduce(X, Car), Res).
...
arme_bmw(Guns) :- findall(Gun, (conduce(X, bmw), inarmat(X, Gun)), Guns).
...
arme_marca(Car, Guns) :- setof(Gun, X^(conduce(X, Car), inarmat(X, Gun)), Guns).
...
%marci_arma_unica(_ListaMarci) :- fail.

marci_arma_unica(Cars) :- findall(Car, arme_marca(Car, [_]), Cars).
...
suspect1(Name:Car:Gun) :- suspect(Name:Car:Gun),
						  arme_marca(Car, Guns),
						  \+ (gun_with_unique_owner(G), member(G, Guns)).
						  
						  
gun_with_unique_owner(Gun) :- inarmat(X, Gun), \+ (inarmat(Y, Gun), X \= Y).
...
suspect2(Name:Car:Gun) :- suspect1(Name:Car:Gun),
						  not(brand_with_unique_owner(Car)).

%brand_with_unique_owner(Car) :- conduce(X, Car), \+ (conduce(Y, Car), X \= Y).
brand_with_unique_owner(Car) :- suspect1(Name:Car:_), \+ (suspect1(Name2:Car:_), Name \= Name2).
...
suspect3(Name:Car:Gun) :- suspect2(Name:Car:Gun),
						  not(gun_with_unique_owner2(Gun)).
						  
gun_with_unique_owner2(Gun) :- suspect2(Name:_:Gun), \+ (suspect2(Name2:_:Gun),  Name \= Name2).
...
suspect4(Name:Car:Gun) :- suspect3(Name:Car:Gun),
						  not(brand_with_unique_owner2(Car)).

brand_with_unique_owner2(Car) :- suspect3(Name:Car:_), \+ (suspect3(Name2:Car:_), Name \= Name2).
...
suspect5(Name:Car:Gun) :- suspect4(Name:Car:Gun),
						  gun_with_unique_owner3(Gun).
						  
gun_with_unique_owner3(Gun) :- suspect4(Name:_:Gun), \+ (suspect4(Name2:_:Gun),  Name \= Name2).
...
suspect6(Name:Car:Gun) :- suspect5(Name:Car:Gun),
						  brand_with_unique_owner3(Car).

brand_with_unique_owner3(Car) :- suspect5(Name:Car:_), \+ (suspect5(Name2:Car:_), Name \= Name2).
